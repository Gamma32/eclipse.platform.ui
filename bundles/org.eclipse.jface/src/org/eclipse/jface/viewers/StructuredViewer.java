...
public abstract class StructuredViewer<E,I> extends ContentViewer<E,I> implements IPostSelectionProvider {
	...
	public ISelection getSelection() {
		...
		List<Object> list = getSelectionFromWidget();
	 ...
	 */
	protected abstract void setSelectionToWidget(List<Object> l, boolean reveal);
	...
	protected void setSelectionToWidget(ISelection selection, boolean reveal) {
		if (selection instanceof IStructuredSelection) {
			...
			setSelectionToWidget((List<Object>) null, reveal);
		}
	}
