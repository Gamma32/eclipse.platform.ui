...
public abstract class ViewerFilter<E,I> {
     ...
     */
    public E[] filter(Viewer<I> viewer, I parent, E[] elements) {
     ...
     * @since 3.2
     */
    public E[] filter(Viewer<I> viewer, TreePath<I> parentPath, E[] elements) {
     ...
     */
    public abstract boolean select(Viewer<I> viewer, I parentElement,
            E element);
}
