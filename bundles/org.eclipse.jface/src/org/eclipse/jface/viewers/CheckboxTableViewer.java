 ...
 */
public class CheckboxTableViewer<E,I> extends TableViewer<E,I> implements ICheckable {
	...
	protected void doUpdateItem(Widget widget, Object element, boolean fullMap) {
    	super.doUpdateItem(widget, (E)element, fullMap);
    ...
    public boolean getChecked(Object element) {
        Widget widget = findItem((E)element);
