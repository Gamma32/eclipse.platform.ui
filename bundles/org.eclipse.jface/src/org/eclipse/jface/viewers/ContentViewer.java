...
public abstract class ContentViewer<E,I> extends Viewer<I>{
     ...
     */
    public void setContentProvider(IContentProvider<? extends I> contentProvider) {
        Assert.isNotNull(contentProvider);
        IContentProvider<I> oldContentProvider = this.contentProvider;
        this.contentProvider = (IContentProvider<I>) contentProvider;
        if (oldContentProvider != null) {
            ...
            ((IContentProvider<I>)contentProvider).inputChanged(this, null, currentInput);
            refresh();
        }
    }
